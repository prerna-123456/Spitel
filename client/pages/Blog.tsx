...
export default function Blog() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="bg-black text-white py-6 md:py-10 px-4 sm:px-6 ml-4 md:ml-0 mr-4 md:mr-0">

        {/* ================= HEADING ================= */}
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-[38px] sm:text-[60px] md:text-[89px] font-montserrat font-bold animate-slideInTogether">
            Blog
          </h2>

          <p className="text-white mt-4 text-[16px] sm:text-[15px] md:text-[16px] font-montserrat font-regular max-w-lg md:max-w-xl mx-auto animate-slideInTogether leading-relaxed">
            Stay updated with the latest trends in web design, development, and digital innovation.
            Explore insights, tips, and strategies to grow your online presence effectively.
          </p>
        </div>

        {/* ================= BLOG CARDS ================= */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 max-w-[1390px] mx-auto">
          ...
          <div className="bg-[#111111] shadow-2xl rounded-xl overflow-hidden p-4 animate-fadeUp md:ml-12">
            ...
            {/* Date Row */}
            <div className="flex items-center gap-2 text-white text-[16px] sm:text-[15px] md:text-[16px] mt-4 px-2 ml-2 md:ml-4">
              <FiCalendar className="text-white" />
              <span>24 February 2026</span>
            </div>

            <div className="p-4 sm:p-6">
              <h3 className="text-[22px] sm:text-[22px] md:text-[24px] font-montserrat font-bold mb-2">
                Modern Web Design <br className="hidden md:block" />
                Trends
              </h3>

              <p className="text-[#B1B1B1] text-[16px] sm:text-[15px] md:text-[16px] font-montserrat font-medium mb-5 leading-relaxed">
                Discover the latest web design trends that enhance user experience and boost engagement...
              </p>

              <a href="/web-design">
                <button className="bg-[#04D78D] rounded-[8px] text-white px-4 sm:px-5 py-2 text-[16px] md:text-[16px] font-montserrat font-semibold transition">
                  Read More
                </button>
              </a>
            </div>
