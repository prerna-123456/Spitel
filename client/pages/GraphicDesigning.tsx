...
export default function GraphicDesigning() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section
        className="relative bg-black text-white py-10 md:py-16 bg-cover bg-center"
      ...
      >
        ...
        {/* TOP BLEND OVERLAY */}
        <div className="absolute top-0 left-0 w-full h-40 md:h-80 bg-gradient-to-t from-transparent via-black/10 to-black z-20" />

        <div className="relative max-w-8xl mx-auto px-4 md:px-6">

          {/* ================= HEADING ================= */}
          <h2 className="text-[38px] md:text-[89px] text-center font-bold font-montserrat relative z-30 animate-slideInTogether">
            Graphic{" "}
          ...
          <div className="flex justify-center animate-slideInTogether relative z-30">
            <a href="/our-services">
              <button
                className="flex items-center gap-2 text-white transition-all duration-300 mt-10 md:mt-16 mr-0 md:mr-10"
              >
          ...
          <div className="mt-10 md:mt-16">
            <h3 className="text-[38px] md:text-[59px] font-montserrat font-bold mb-6 md:mb-10 ml-0 md:ml-20 animate-slideLeftFade text-center md:text-left">
              Posters
            </h3>
            ...
            <div className="relative w-full flex items-center justify-center">
              ...
              <button
                onClick={prevSlide}
                className="absolute left-2 md:left-4 z-20 bg-white text-black w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-lg"
              >
                <IoArrowBack />
              </button>
              ...
              <button
                onClick={nextSlide}
                className="absolute right-2 md:right-4 z-20 bg-white text-black w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-lg"
              >
                <IoArrowForward />
              </button>
          ...
          <div
            ref={brandingRef}
            className="mt-16 md:mt-24 ml-4 md:ml-20 mr-4 md:mr-20 relative z-30 mb-16 md:mb-20"
          >
            <h3
              className={`text-[38px] md:text-[59px] font-montserrat font-bold mb-6 md:mb-10 text-center md:text-left ${showBranding
            ...
            <div
              className={`grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 ml-4 md:ml-0 mr-4 md:mr-0${showBranding
                ? "animate-slideInTogether"
                : "opacity-0 translate-y-10"
                }`}
            >

              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774606973/fable_wrdhqd.mp4"
                autoPlay
                loop
                muted
                playsInline
                className="h-[220px] md:h-[307px] w-full md:w-[437px] rounded-[10px] border-[1px] border-[#C6C6C6] object-cover"
              />

              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774606965/lighthouse_imwpk2.mp4"
                autoPlay
                loop
                muted
                playsInline
              ...
              <video
                ...
                muted
                playsInline
                className="h-[220px] md:h-[307px] w-full md:w-[407px] rounded-[10px] border-[1px] border-[#C6C6C6] object-cover"
              />
