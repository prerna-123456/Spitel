...
export default function ChatbotDevelopment() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="relative min-h-screen -mt-20 -mb-20 px-6 md:px-12 lg:px-20 py-80 text-white overflow-hidden">

        {/* TOP BLEND OVERLAY */}
        <div className="absolute top-0 left-0 w-full h-[400px] bg-gradient-to-t from-transparent via-black/10 to-black z-20" />
        ...
        {/* ===== CONTENT ===== */}
        <div className="relative z-30 -mt-52">

          {/* HEADING */}
          <h1 className="text-center text-[38px] md:text-[89px] font-montserrat font-bold leading-[0.95] animate-slideInTogether">
            Chatbot <br />
          ...
          <div className="w-full flex justify-center">
            <p className="text-center text-[#B1B1B1] text-[16px] font-montserrat max-w-xl mx-auto mt-6 mb-10 md:mb-16 animate-slideInTogether ml-4 md:ml-0 mr-4 md:mr-0">
              We build intelligent chatbots that help businesses automate
              conversations, improve customer support, and increase
          ...
          <div className="flex justify-center animate-slideInTogether">
            <a href="/our-services">
              <button className="flex items-center gap-2 text-white transition-all duration-300 mr-10">
          ...
          {/* ===== MOBILE VERSION ===== */}
          <div className="md:hidden relative mt-24 flex justify-center">
            ...
            <img
              src="/phone1.png"
              alt=""
              className="absolute left-0 -top-12 w-[120px]"
            />
            ...
            <img
              src="/phone2.png"
              alt=""
              className="absolute left-0 bottom-10 w-[120px]"
            />
            ...
            <img
              src="/phone5.png"
              alt=""
              className="absolute right-0 -top-12 w-[120px]"
            />
            ...
            <img
              src="/phone4.png"
              alt=""
              className="absolute right-0 bottom-10 w-[120px]"
            />
            ...
            <img
              src="/phone3.png"
              alt=""
              className="absolute bottom-[-100px] w-[140px]"
            />

          </div>

          {/* ===== ORIGINAL DESKTOP LAYOUT (UNCHANGED — COPY SAME) ===== */}
          <div className="relative mt-24 items-center justify-center hidden md:flex">

            {/* CENTER IMAGE */}
            <div className="relative z-20 animate-slideInTogether">
              <img
                className="w-[320px] md:w-[450px] drop-shadow-[0_0_60px_rgba(128,228,31,0.8)]"
                src="/chatbot.png"
            ...
            {/* LEFT TOP */}
            <div className="absolute left-0 top-0 md:left-12 md:top-0 ml-28 animate-slideLeftFade">
              <img src="/phone1.png" alt="AI Chatbots" className="w-[220px] md:w-[260px]" />
            </div>

            {/* LEFT BOTTOM */}
            <div className="absolute left-0 bottom-0 md:left-12 mb-0 ml-28 animate-slideLeftFade">
              <img src="/phone2.png" alt="AI Chatbots" className="w-[220px] md:w-[260px]" />
            </div>

            {/* RIGHT TOP */}
            <div className="absolute right-0 top-0 md:right-12 md:top-0 mr-28 animate-slideRightFade">
              <img src="/phone5.png" alt="AI Chatbots" className="w-[220px] md:w-[260px]" />
            </div>

            {/* RIGHT BOTTOM */}
            <div className="absolute right-0 bottom-0 md:right-12 mb-0 mr-28 animate-slideRightFade">
              <img src="/phone4.png" alt="AI Chatbots" className="w-[220px] md:w-[260px]" />
            </div>

            {/* BOTTOM CENTER — EXACT SAME */}
            <div className="absolute mt-[600px] animate-fadeUp">
              <img
                src="/phone3.png"
                alt="AI Chatbots"
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 w-full h-[400px] bg-gradient-to-b from-transparent via-black/40 to-black" />
      </section>
