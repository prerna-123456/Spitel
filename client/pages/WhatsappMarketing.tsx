...
export default function WhatsappMarketing() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* WhatsApp Marketing */}
      <section
        className="relative px-6 md:px-12 lg:px-20 py-16 bg-black overflow-hidden"
      >
    ...
    bg-gradient-to-t from-transparent via-black/60 to-black z-20">
        ...
        {/* ================= HEADING ================= */}
        <h2 className="text-[38px] md:text-[89px] text-center font-bold font-montserrat relative z-30 animate-slideInTogether leading-[1.1] md:leading-[0.95] px-2">
          Whatsapp <br />
        ...
        <div className="flex justify-center animate-slideInTogether relative z-30">
          <a href="/our-services">
            <button
              className="flex items-center gap-2 text-white transition-all duration-300 mt-12 md:mr-10 md:mt-16 mb-12"
            >
        ...
        <div
          ref={sectionRef}
          className="relative z-10 max-w-8xl mx-auto mt-24 px-4 md:px-0 md:ml-16"
        >

          {/* Heading */}
          <h2
            className={`text-[30px] md:text-[59px] font-bold font-montserrat mb-8 md:mb-16
      ${isVisible ? "animate-slideLeftFade opacity-100" : "opacity-0"}`}
          ...
          {/* Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-14 gap-x-10 md:gap-x-40">

            {/* LEFT COLUMN */}
            <div
              className={`space-y-8 md:space-y-14 transition-all duration-700
        ${isVisible ? "animate-slideLeftFade opacity-100" : "opacity-0 translate-x-[-40px]"}`}
            >

              <div className="flex items-start gap-4">
                <span className="text-[#04D78D] text-xl mt-2"><FaArrowRight /></span>
                <div>
                  <h3 className="text-[#04D78D] text-[24px] md:text-[28px] font-semibold font-montserrat">
                    Promotional Campaigns
                  </h3>
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Offers, discounts, and product launches.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[#04D78D] text-[24px] md:text-[28px] font-semibold font-montserrat">
                    Customer Engagement <br />Campaigns
                  </h3>
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Updates, greetings, and brand <br />communication.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 relative z-30">
                ...
                <div>
                  ...
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Bring back inactive or past customers.
                  </p>
                </div>
              </div>
            ...
            {/* RIGHT COLUMN */}
            <div
              className={`space-y-8 md:space-y-14 transition-all duration-700 delay-200
        ${isVisible ? "animate-slideRightFade opacity-100" : "opacity-0 translate-x-[40px]"}`}
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Follow-ups that convert prospects into <br />customers.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Order confirmations, alerts, and <br />reminders.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 relative z-30">
                ...
                <div>
                  <h3 className="text-[#04D78D] text-[24px] md:text-[28px] font-semibold font-montserrat">
                    Event & Announcement <br />Campaigns
                  </h3>
                  <p className="text-[#B1B1B1] text-[18px] font-montserrat font-regular mt-2">
                    Event invites, launches, and important <br />updates.
                  </p>
                </div>
              </div>
        ...
        {/* BLEND */}
        <div
          className="pointer-events-none absolute bottom-0 left-0 w-full h-[500px]
