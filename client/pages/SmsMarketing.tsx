...
export default function SmsMarketing() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* ================= SECTION 1 ================= */}
      <section className="bg-black text-white px-6 md:px-20 py-16 md:py-20">

        {/* Heading */}
        <h1 className="text-center text-[38px] md:text-[89px] font-bold font-montserrat animate-slideInTogether leading-tight">
          SMS <span className="text-[#04D78D] italic font-playfair">Marketing</span>
        </h1>
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-16">
          ...
          {/* LEFT IMAGE */}
          <div className="flex justify-center md:justify-start animate-slideLeftFade">
            <img
              src="/sms1.jpg"
              alt="SMS Illustration"
              className="w-full max-w-[500px] md:max-w-none md:w-[550px] 
        rounded-[20px] ml-0 md:ml-20"
            />
          </div>
    ...
    mx-auto md:mx-0 
    mr-4 md:mr-16 ml-4 md:ml-0
    animate-slideRightFade">

            <h2 className="text-[26px] md:text-[39px] font-semibold font-montserrat leading-[1.3]">
              Instant messages that drive engagement and action.
            </h2>

            <p className="text-[#B1B1B1] text-[16px] md:text-[16px] font-montserrat 
      mt-6 leading-[1.6] 
      max-w-full md:max-w-[750px] 
      mx-auto md:mx-0">
              We help brands reach customers instantly through targeted SMS
              campaigns that deliver timely updates, promotions, and offers —
              driving engagement, responses, and conversions with high open
              rates.
            </p>
      ...
      <section
        ref={sectionRef}
        className="bg-black text-white px-6 md:px-20 py-4 mb-8 md:mb-28"
      >

        {/* Heading */}
        <h2
          className={`text-center text-[32px] md:text-[59px] font-bold font-montserrat mb-10 md:mb-20 
    ${isVisible ? "animate-slideInTogether" : "opacity-0"}`}
        >
          Our SMS capabilities
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-16 md:gap-40">

          {/* LEFT SIDE */}
          <div
            className={`space-y-12 md:space-y-32 
      ml-0 md:ml-16 
      ${isVisible ? "animate-slideLeftFade" : "opacity-0"}`}
          >

            <div className="max-w-full md:max-w-[360px] 
      ml-0 md:ml-auto 
      text-center md:text-center">
              <h3 className="text-white text-[26px] md:text-[30px] font-montserrat font-semibold">
                Promotional SMS
              </h3>

              <p className="text-[#B1B1B1] text-[16px] md:text-[16px] font-montserrat mt-4 leading-[1.6]">
                Send offers, discounts, and campaign messages that drive quick action.
              </p>
            </div>
      ...
      text-center md:text-center">
              ...
              <p className="text-[#B1B1B1] text-[16px] md:text-[16px] font-montserrat mt-4 leading-[1.6]">
                Enable direct conversations and customer responses through messaging.
              </p>
            </div>
      ...
      ${isVisible ? "animate-slideInTogether" : "opacity-0"}`}
        ...
        md:max-w-none md:w-[438px] 
        drop-shadow-[0_0_25px_#155DFC]"
            />
          </div>
          ...
          <div
            className={`space-y-12 md:space-y-32 
      mr-0 md:mr-14
      ${isVisible ? "animate-slideRightFade" : "opacity-0"}`}
          >

            <div className="max-w-full md:max-w-[360px] mx-auto text-center">
              <h3 className="text-white text-[26px] md:text-[30px] font-montserrat font-semibold">
                Transactional SMS
              </h3>

              <p className="text-[#B1B1B1] text-[16px] md:text-[16px] font-montserrat mt-4 leading-[1.6]">
                Automated messages for updates, confirmations, and reminders.
              </p>
            </div>
            ...
            <div className="max-w-full md:max-w-[360px] mx-auto text-center">
              ...
              <p className="text-[#B1B1B1] text-[16px] md:text-[16px] font-montserrat mt-4 leading-[1.6]">
                Reach a large audience instantly with mass messaging campaigns.
              </p>
            </div>
