...
export default function MobileDevelopment() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="bg-black px-6 md:px-12 lg:px-20 py-10 -mb-20">

        <div className="max-w-8xl mx-auto ml-4 md:ml-0 mr-4 md:mr-0">

          {/* HEADING */}
          <h2 className="text-white text-[38px] md:text-[89px] mb-10 text-center font-bold font-montserrat leading-[1.3] lg:leading-[0.95] animate-slideInTogether">
            Mobile App
            <br />
          ...
          <p className="
            text-white 
            mt-10 md:mt-20 
            text-[24px] sm:text-[30px] md:text-[39px] 
          ...
          ">
            ...
            <br className="hidden md:block" /> for iOS and Android.
          </p>
          ...
          {/* PHONES SECTION */}
          <div className="-mt-4 lg:ml-16 lg:-mt-24 ml-4 md:ml-0 overflow-hidden">
            ...
            <div className="lg:hidden mt-4">
              ...
              <div className="grid grid-cols-1">
                ...
                <img
                  src="/mobile-app1.png"
                  alt="App Preview 1"
                  className="w-[260px] h-[400px] animate-fadeUp"
                />

                <img
                  src="/mobile-app2.png"
                  alt="App Preview 2"
                  className="w-[440px] h-[440px] ml-20 -mt-[440px] animate-fadeUp"
                />

                <img
                  src="/mobile-app3.png"
                  alt="App Preview 3"
                  className="w-[440px] h-[420px] -ml-14 -mt-28 animate-fadeUp"
                />
            ...
            <div className="hidden lg:flex items-end">
              ...
              <img
                src="/mobile-app1.png"
                alt="App Preview 1"
                className="w-[452px] h-[628px] animate-fadeUp"
              />

              <img
                src="/mobile-app2.png"
                alt="App Preview 2"
                className="w-[552px] h-[690px] -ml-[338px] animate-fadeDown"
              />

              <img
                src="/mobile-app3.png"
                alt="App Preview 3"
                className="w-[552px] h-[670px] -ml-60 animate-fadeUp"
              />
