...
export default function PhotographyVideography() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="relative bg-black py-14 md:py-20 px-6 md:px-16 lg:px-28 text-white">

        {/* Heading */}
        <div className="text-center mb-12 md:mb-20">
          <h2 className="text-[38px] md:text-[89px] font-bold font-montserrat leading-[1.1] animate-slideInTogether">
            Photography &{" "} <br />
            <span className="text-[#04D78D] italic font-bold font-playfair">
              Videography
            </span>
          </h2>
          ...
          <div className="flex justify-center animate-slideInTogether">
            <a href="/our-services">
              <button
                className="flex items-center gap-2 text-white transition-all duration-300 mr-10 mt-10 md:mt-16"
              >
          ...
          <h3 className="text-[30px] md:text-[59px] mt-10 md:mt-24 font-semibold font-montserrat animate-fadeUp">
            What We Offer
          </h3>
        </div>

        {/* ===== FIRST ROW ===== */}
        <div className="grid grid-cols-1 md:grid-cols-3 text-center mr-4 md:mr-0 ml-4 md:ml-0 gap-14 md:gap-0">
          ...
          <div className="group w-full md:w-[383px] mx-auto animate-fadeUp">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774607228/videography1_a8i7zd.mov"
          ...
          <div className="group w-full md:w-[383px] mx-auto animate-fadeDown">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774607198/videography3_qfkbwi.mov"
                className="w-full md:w-[383px] h-[420px] md:h-[495px] object-cover transition-transform duration-500"
                autoPlay
                loop
                muted
          ...
          <div className="group w-full md:w-[383px] mx-auto animate-fadeUp">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774607253/videography2_j8mzd7.mov"
                className="w-full md:w-[383px] h-[420px] md:h-[495px] object-cover transition-transform duration-500"
                autoPlay
                loop
                muted
        ...
        {/* ===== SECOND ROW ===== */}
        <div className="grid grid-cols-1 md:grid-cols-3 text-center mt-20 mr-4 md:mr-0 ml-4 md:ml-0 gap-14 md:gap-0">

          {/* Video 4 */}
          <div className="group w-full md:w-[383px] mx-auto animate-fadeUp">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774607211/videography4_a4tuga.mov"
                className="w-full md:w-[383px] h-[420px] md:h-[495px] object-cover transition-transform duration-500"
                autoPlay
                loop
                muted
          ...
          <div className="group w-full md:w-[383px] mx-auto animate-fadeDown">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774607197/videography5_szodqh.mov"
                className="w-full md:w-[383px] h-[420px] md:h-[495px] object-cover transition-transform duration-500"
                autoPlay
                loop
                muted
          ...
          <div className="group w-full md:w-[383px] mx-auto animate-fadeUp">
            <div className="relative rounded-[10px] overflow-hidden shadow-lg">
              <video
                src="https://res.cloudinary.com/dnrpf4rsx/video/upload/v1774613171/videography6_e49tz2.mp4"
                className="w-full md:w-[383px] h-[420px] md:h-[495px] object-cover transition-transform duration-500"
                autoPlay
                loop
                muted
        ...
        <div
          ...
          <h3
            className={`text-[30px] sm:text-[32px] md:text-[39px] 
          ...
          <div className="relative w-full flex items-center justify-center">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 md:-left-16 z-20 bg-white text-black w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-lg"
            >
              <IoArrowBack />
            </button>

            {/* SLIDER */}
            <div className="overflow-hidden w-full md:w-[1300px] px-8 md:px-0">
              <div
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 md:-right-16 z-20 bg-white text-black w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-lg"
            >
              <IoArrowForward />
            </button>
          </div>
