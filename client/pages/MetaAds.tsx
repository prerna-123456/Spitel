...
export default function MetaAds() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* ================= SECTION 1 ================= */}
      <section className="relative py-14 md:py-20 px-6 md:px-20 text-center overflow-hidden">

        <div className="relative z-10">

          {/* Heading */}
          <h2 className="text-[38px] sm:text-4xl md:text-[89px] font-bold font-montserrat animate-slideInTogether">
            Meta <span className="text-[#04D78D] italic font-playfair">Ads</span>
          </h2>

           <p className="text-[16px] md:text-[16px] text-[#B1B1B1] font-montserrat font-medium text-center mt-4 md:mt-10 animate-slideInTogether">
            We plan and manage performance-driven campaigns across Meta platforms, <br />
            focusing on precise audience targeting, conversion optimization, and <br />
            continuous data analysis. Our approach is designed to maximize return on ad spend <br />
            and deliver consistent, scalable results..
          </p>

          {/* BACK BUTTON */}
          <div className="flex justify-center animate-slideInTogether relative z-30">
            <a href="/our-services">
              <button
                className="flex items-center gap-2 text-white transition-all duration-300 
                  mt-10 md:mt-16 md:mr-10"
              >
          ...
          {/* Sub Heading */}
          <p className="mt-12 md:mt-20 text-[26px] sm:text-3xl md:text-[59px] 
    text-white font-montserrat font-bold animate-slideInTogether">
            Our expertise covers
          </p>

          {/* Expertise Grid */}
          <div className="mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-10 items-center">

            {/* Facebook */}
            <div className="animate-slideLeftFade ml-4 md:ml-0 mr-4 md:mr-0 hidden md:block">
              <h3 className="text-white text-[26px] sm:text-2xl md:text-[30px] 
        font-semibold font-montserrat mb-3">
                Facebook Ads
              </h3>

              <p className="text-[#B1B1B1] text-[16px] sm:text-base md:text-[16px] 
        font-montserrat leading-relaxed">
                Targeted ads that build reach, leads,
                and conversions.
              </p>
            </div>
          ...
          drop-shadow-[0_0_20px_#2196F3]"
              />
            </div>

            {/* Facebook */}
            <div className="animate-slideLeftFade ml-4 md:ml-0 mr-4 md:mr-0 md:hidden">
              <h3 className="text-white text-[26px] sm:text-2xl md:text-[30px] 
        font-semibold font-montserrat mb-3">
                Facebook Ads
              </h3>
        ...
        font-montserrat leading-relaxed">
            ...
            {/* Instagram */}
            <div className="animate-slideRightFade ml-4 md:ml-0 mr-4 md:mr-0">
              <h3 className="text-white text-[26px] sm:text-2xl md:text-[30px] 
        font-semibold font-montserrat mb-3">
                Instagram Ads
              </h3>
              ...
              <p className="text-[#B1B1B1] text-[16px] sm:text-base md:text-[16px] 
        font-montserrat leading-relaxed">
                Visually engaging ads designed to
          ...
          {/* WhatsApp */}
          <div className="mt-12 md:mt-14 animate-fadeUp ml-4 md:ml-0 mr-4 md:mr-0">
            <h3 className="text-white text-[26px] sm:text-2xl md:text-[30px] 
      font-semibold font-montserrat mb-3">
              WhatsApp Ads
            </h3>
            ...
            <p className="text-[#B1B1B1] text-[16px] sm:text-base md:text-[16px] 
      font-montserrat max-w-xl mx-auto leading-relaxed">
              Click-to-WhatsApp ads that turn interest
              into direct conversations and conversions.
            </p>
          </div>
      ...
      <section
        ref={section2Ref}
        className="relative py-10 md:py-24 px-6 md:px-20 text-center overflow-hidden"
      >
        <div className="relative z-10 max-w-4xl mx-auto">

          {/* Heading */}
          <h3
            className={`text-[38px] sm:text-2xl md:text-[59px] font-semibold font-montserrat mb-8 md:mb-10
      transition-all duration-700
      ${section2Visible
                ? "animate-slideInTogether opacity-100"
          ...
          {/* Description */}
          <p
            className={`text-[#B1B1B1] text-[16px] sm:text-base md:text-[16px] 
      leading-relaxed md:leading-[1.3] 
      font-regular font-montserrat ml-4 md:ml-0 mr-4 md:mr-0
      ...
      ${section2Visible
          ...
          >
            We create and manage high-performing Meta ad campaigns that connect your brand
            with the right audience at the right time. From audience targeting and creative strategy
            to ad optimization and performance tracking, we focus on driving qualified leads,
            increasing conversions, and maximizing return on ad spend across Facebook and
            Instagram.
          </p>

          {/* Image */}
          <div
            className={`mt-10 md:mt-14 flex justify-center transition-all duration-700 delay-300 ml-4 md:ml-0 mr-4 md:mr-0
      ${section2Visible
          ...
          >
            <img
              src="/meta2.jpg"
              alt="Meta Marketing"
              className="rounded-[20px] w-full sm:w-[90%] md:w-[70%]"
            />
          </div>
